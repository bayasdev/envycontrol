...
MODESET_S0ix = '''# Automatically generated by EnvyControl
...
def graphics_mode_switcher(graphics_mode, user_display_manager, enable_force_comp, coolbits_value, rtd3_value, enable_s0ix):
    ...
    if graphics_mode == 'integrated':
        ...
        if enable_s0ix == None:
            ...
            # setup S0ix
            create_file(MODESET_PATH, MODESET_S0ix)
...
def main():
    ...
    parser.add_argument('--s0ix', action='store_true',
                        help='Enable S0ix-based power management on Nvidia mode')
    ...
    if args.query:
        ...
        graphics_mode_switcher(args.switch, args.dm,
                               args.force_comp, args.coolbits, args.rtd3, args.s0ix)
