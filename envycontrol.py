...
XSETUP_NVIDIA_XRANDR_SCRIPT_PATH = '/etc/X11/Xsetup.d/90envycontrol_nvidia-xrandr'

XSETUP_NVIDIA_XRANDR_SCRIPT = '''# Automatically generated by EnvyControl
...
def _cleanup():
    ...
    to_remove = (BLACKLIST_PATH, UDEV_INTEGRATED_PATH, UDEV_PM_PATH, XORG_PATH, EXTRA_PATH, '/etc/X11/xorg.conf.d/90-nvidia.conf', MODESET_PATH, LIGHTDM_SCRIPT_PATH, LIGHTDM_CONFIG_PATH, XSETUP_NVIDIA_XRANDR_SCRIPT_PATH)
...
def _setup_display_manager(display_manager):
    ...
    if display_manager == 'sddm':
        ...
        if igpu_vendor == "amd":
            amd_name = _get_amd_igpu_name()
            _create_file(XSETUP_NVIDIA_XRANDR_SCRIPT_PATH, XSETUP_NVIDIA_XRANDR_SCRIPT.format(amd_name))
        else:
            _create_file(XSETUP_NVIDIA_XRANDR_SCRIPT_PATH, XSETUP_NVIDIA_XRANDR_SCRIPT.format("modesetting"))
